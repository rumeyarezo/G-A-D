-- 0000: esquema-base do Grana a Dois (o que já existia no projeto antigo), para criar o projeto novo e separado.
-- Só deve ser aplicado em um projeto Supabase NOVO (no antigo essas tabelas já existem).
