...
- `python3 apps/site/make_icons.py` gera os ícones e `python3 apps/site/build.py` monta `apps/site/dist` (manifest, service worker, supabase-js local). `dist` é versionado para poder ser publicado direto.
